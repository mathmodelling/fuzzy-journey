...
# Para aplicarlo se debe leer el archivo de Excel que resulta de aplicar el script 02_Complementar_Promedio
...
excel_entrada = 'Datos/02 VALORES MEDIOS MENSUALES DE TEMPERATURA Complementados.xlsx'
excel_salida = 'Datos/03 VALORES MEDIOS MENSUALES DE TEMPERATURA Prueba_de_Rachas.xlsx'
